% MODBOX-SHA224SUM(1) modbox | User Commands
% modbox project
% 2026-08-09

# NAME

modbox-sha224sum - compute and check SHA224 (224-bit) checksums

# SYNOPSIS

**modbox sha224sum** [*OPTION*]... [*FILE*]...
...
**--tag**
:   Produce a BSD-style checksum line of the form `SHA224 (file) = hash`.
...
```bash
# Compute the SHA224 checksum of a file
modbox sha224sum file.iso

# Compute checksums of several files at once
modbox sha224sum file1 file2 file3 > checksums.sha224

# Verify checksums recorded earlier
modbox sha224sum -c checksums.sha224

# Checksum standard input from a pipeline
cat file.iso | modbox sha224sum

# Verify strictly, reporting only the final status
modbox sha224sum -c --status --strict checksums.sha224
```
