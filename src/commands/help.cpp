...
void output_help(const char* argv0, const char* progname) {
    if (strcmp(progname, "modbox") == 0) {
        ...
        printf("  nohup  Run a command immune to hangups, with output to a non-tty\n");
        ...
        printf("  seq    Print a sequence of numbers\n");
        printf("  sleep  Delay for a specified amount of time\n");
        printf("  sort   Sort lines of text files\n");
        printf("  stat   Display file or file system status\n");
        printf("  stty   Print or change terminal characteristics\n");
